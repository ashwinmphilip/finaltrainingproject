...
public class WelcomeController {
	...
	public ShowStudentListConfirmation showStudentByDate() {
		return studentServiceImpl.showStudentByDate();
	}
	
	@GetMapping("/studentshowwithoutfees")
	public ShowStudentListConfirmation showStudentWithoutFees() {
		return studentServiceImpl.showStudentWithoutFees();
	}
	
	@GetMapping("/studentshowwithfees")
	public ShowStudentListConfirmation showStudentWithFees() {
		return studentServiceImpl.showStudentWithFees();
	}
	
	@GetMapping("/coursestudentshow/{id}")
	public ShowStudentDetailsListConfirmation showCourseStudent(@PathVariable("id") Long id) {
		return studentServiceImpl.showCourseStudent(id);
	}
	
	@GetMapping("/studentcourseshow/{id}")
	public ShowCourseListConfirmation showStudentCourse(@PathVariable("id") Long id) {
		return studentServiceImpl.showStudentCourse(id);
	}
	
	@GetMapping("/totalfee")
	public Double showTotalFeeCollected() {
		return studentServiceImpl.showTotalFeeCollected();
	}
	
	@GetMapping("/balancefee")
	public Double showBalanceFeeCollected() {
		return studentServiceImpl.showBalanceFeeCollected();
	}
}
